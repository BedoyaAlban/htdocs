...
<body id="top">
    ...
    <header class="s-header">
        ...
        <div class="header-logo">
            <a class="site-logo" href="index.html"><img src="../../public/images/logo.png" alt="Homepage"></a>
        </div>
                ...
                <div class="masonry__brick">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__thumb">
                            <a href="../../public/images/portfolio/gallery/g-beetle.jpg" class="thumb-link" title="The Beetle Car" data-size="1050x700">
