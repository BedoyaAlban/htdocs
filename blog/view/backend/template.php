...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="/blog/public/css/base.css">
    ...
    <link rel="icon" href="/blog/public/favicon.ico" type="image/x-icon">
...
<body id="top" class=" pace-done">
    ...
    <header class="s-header">
        ...
        <nav class="header-nav-wrap">
            <ul class="header-nav">
                <li><a href="/blog/adminView" class="admin" >Home</a></li>
                <li><a href="/blog/CreatePostView" class="admin" >Créer</a></li>
                <li><a href="/blog/viewCommentsAdmin" class="admin" >Moderation</a></li>
            </ul>
        </nav>

        <nav class="header-nav-wrapleft">
            <ul class="header-navleft">
                <li><a href="/blog/connexion" class="admin" >Connexion</a></li>
                <li><a href="/blog/deconnexion" class="admin" >Déconnexion</a></li>
            </ul>
        </nav>
        ...
        <div class="row">
            <div class="col-full">
                ...
                <div class="footer-logo">
                    <a class="footer-site-logo" href=""><img src="/blog/public/images/logo.png" alt="Homepage"></a>
                </div>
    ...
    <!-- Java Script
    ================================================== -->
    <script src="/blog/public/js/jquery-3.2.1.min.js"></script>
    <script src="/blog/public/js/plugins.js"></script>
